...
(1, 1, 5, (CURRENT_DATE + INTERVAL '0 days')::date),   (1, 2, 8, (CURRENT_DATE + INTERVAL '173 days')::date),   (1, 3, 50, (CURRENT_DATE + INTERVAL '0 days')::date),  
(1, 4, 3, (CURRENT_DATE + INTERVAL '4 days')::date),   (1, 5, 45, (CURRENT_DATE + INTERVAL '14 days')::date),  (2, 6, 80, (CURRENT_DATE + INTERVAL '35 days')::date),
(2, 7, 110, (CURRENT_DATE + INTERVAL '69 days')::date), (3, 8, 250, (CURRENT_DATE + INTERVAL '82 days')::date), (3, 9, 140, (CURRENT_DATE + INTERVAL '124 days')::date),
(4, 10, 65, (CURRENT_DATE + INTERVAL '9 days')::date), (4, 11, 35, (CURRENT_DATE + INTERVAL '11 days')::date), (5, 12, 15, (CURRENT_DATE + INTERVAL '174 days')::date),
(5, 13, 25, (CURRENT_DATE + INTERVAL '174 days')::date), (1, 14, 12, (CURRENT_DATE + INTERVAL '325 days')::date), (2, 15, 18, (CURRENT_DATE + INTERVAL '325 days')::date),
(3, 16, 75, (CURRENT_DATE + INTERVAL '247 days')::date), (4, 17, 130, (CURRENT_DATE + INTERVAL '285 days')::date),(5, 18, 40, (CURRENT_DATE + INTERVAL '30 days')::date),
(1, 19, 28, (CURRENT_DATE + INTERVAL '56 days')::date), (2, 20, 55, (CURRENT_DATE + INTERVAL '71 days')::date), (1, 21, 12, (CURRENT_DATE + INTERVAL '4 days')::date),  
(2, 22, 6, (CURRENT_DATE + INTERVAL '3 days')::date),  (5, 25, 15, (CURRENT_DATE + INTERVAL '7 days')::date), (1, 26, 25, (CURRENT_DATE + INTERVAL '3 days')::date),  
(2, 27, 40, (CURRENT_DATE + INTERVAL '21 days')::date), (3, 28, 35, (CURRENT_DATE + INTERVAL '21 days')::date), (3, 43, 50, (CURRENT_DATE + INTERVAL '2 days')::date),  
(3, 38, 40, (CURRENT_DATE + INTERVAL '14 days')::date), (3, 23, 150, (CURRENT_DATE + INTERVAL '205 days')::date),(4, 24, 120, (CURRENT_DATE + INTERVAL '205 days')::date), 
(4, 29, 45, (CURRENT_DATE + INTERVAL '303 days')::date), (5, 30, 80, (CURRENT_DATE + INTERVAL '447 days')::date), (1, 31, 60, (CURRENT_DATE + INTERVAL '143 days')::date),  
(2, 32, 55, (CURRENT_DATE + INTERVAL '247 days')::date), (3, 33, 90, (CURRENT_DATE + INTERVAL '283 days')::date), (4, 34, 85, (CURRENT_DATE + INTERVAL '283 days')::date),  
(5, 35, 200, (CURRENT_DATE + INTERVAL '478 days')::date),(1, 36, 150, (CURRENT_DATE + INTERVAL '400 days')::date),(2, 37, 130, (CURRENT_DATE + INTERVAL '334 days')::date), 
(4, 39, 110, (CURRENT_DATE + INTERVAL '417 days')::date),(5, 40, 160, (CURRENT_DATE + INTERVAL '294 days')::date),(1, 41, 85, (CURRENT_DATE + INTERVAL '188 days')::date),  
(2, 42, 140, (CURRENT_DATE + INTERVAL '264 days')::date),(4, 44, 20, (CURRENT_DATE + INTERVAL '691 days')::date), (5, 45, 45, (CURRENT_DATE + INTERVAL '905 days')::date),  
(1, 46, 30, (CURRENT_DATE + INTERVAL '844 days')::date), (2, 47, 40, (CURRENT_DATE + INTERVAL '874 days')::date), (3, 48, 25, (CURRENT_DATE + INTERVAL '766 days')::date),  
(4, 49, 50, (CURRENT_DATE + INTERVAL '822 days')::date), (5, 50, 60, (CURRENT_DATE + INTERVAL '660 days')::date), (1, 51, 15, (CURRENT_DATE + INTERVAL '964 days')::date),  
(2, 52, 120, (CURRENT_DATE + INTERVAL '721 days')::date),(3, 53, 9, (CURRENT_DATE + INTERVAL '539 days')::date),  (4, 54, 75, (CURRENT_DATE + INTERVAL '644 days')::date),  
(5, 55, 35, (CURRENT_DATE + INTERVAL '497 days')::date), (1, 56, 40, (CURRENT_DATE + INTERVAL '905 days')::date), (2, 57, 55, (CURRENT_DATE + INTERVAL '905 days')::date),  
(3, 58, 80, (CURRENT_DATE + INTERVAL '1270 days')::date), (4, 59, 100, (CURRENT_DATE + INTERVAL '1270 days')::date),(5, 60, 4, (CURRENT_DATE + INTERVAL '1270 days')::date),

-- Store 6: Ekkamai BTS (Heavy on quick meals & drinks)
(6, 1, 45, (CURRENT_DATE + INTERVAL '3 days')::date), (6, 11, 80, (CURRENT_DATE + INTERVAL '4 days')::date), (6, 36, 150, (CURRENT_DATE + INTERVAL '400 days')::date),
-- Store 7: Ladprao Crossing (Snacks and basic meds)
(7, 2, 60, (CURRENT_DATE + INTERVAL '173 days')::date), (7, 13, 200, (CURRENT_DATE + INTERVAL '400 days')::date), (7, 50, 40, (CURRENT_DATE + INTERVAL '660 days')::date),
-- Store 8: Chatuchak Market (Water, energy drinks, and umbrellas!)
(8, 8, 300, (CURRENT_DATE + INTERVAL '82 days')::date), (8, 9, 150, (CURRENT_DATE + INTERVAL '124 days')::date), (8, 60, 50, (CURRENT_DATE + INTERVAL '1270 days')::date),
-- Store 9: Samyan Mitrtown (Student heavy: Instant noodles & coffee)
(9, 23, 200, (CURRENT_DATE + INTERVAL '205 days')::date), (9, 24, 180, (CURRENT_DATE + INTERVAL '205 days')::date), (9, 43, 85, (CURRENT_DATE + INTERVAL '2 days')::date),
-- Store 10: Ari Station (Premium skincare and bakery)
(10, 5, 50, (CURRENT_DATE + INTERVAL '14 days')::date), (10, 19, 30, (CURRENT_DATE + INTERVAL '56 days')::date), (10, 44, 25, (CURRENT_DATE + INTERVAL '691 days')::date),
-- Store 11: Huai Khwang (Late night spot: Beer and hot snacks)
(11, 26, 60, (CURRENT_DATE + INTERVAL '3 days')::date), (11, 42, 250, (CURRENT_DATE + INTERVAL '264 days')::date), (11, 6, 180, (CURRENT_DATE + INTERVAL '35 days')::date),
-- Store 12: Phaya Thai Link (Quick transit essentials)
(12, 10, 40, (CURRENT_DATE + INTERVAL '9 days')::date), (12, 12, 15, (CURRENT_DATE + INTERVAL '174 days')::date), (12, 16, 50, (CURRENT_DATE + INTERVAL '247 days')::date),
-- Store 13: Ratchathewi (Mixed residential goods)
(13, 34, 90, (CURRENT_DATE + INTERVAL '283 days')::date), (13, 56, 45, (CURRENT_DATE + INTERVAL '905 days')::date), (13, 58, 100, (CURRENT_DATE + INTERVAL '1270 days')::date),
-- Store 14: MBK Center (Tourist heavy: Candy, chips, and inhalers)
(14, 4, 120, (CURRENT_DATE + INTERVAL '4 days')::date), (14, 7, 200, (CURRENT_DATE + INTERVAL '69 days')::date), (14, 52, 300, (CURRENT_DATE + INTERVAL '721 days')::date),
-- Store 15: Sathorn Thani (Office workers: Mints, pens, and coffee)
(15, 30, 85, (CURRENT_DATE + INTERVAL '447 days')::date), (15, 39, 140, (CURRENT_DATE + INTERVAL '417 days')::date), (15, 59, 150, (CURRENT_DATE + INTERVAL '1270 days')::date),
-- Store 16: Khlong Toei (Household goods and staples)
(16, 35, 250, (CURRENT_DATE + INTERVAL '478 days')::date), (16, 57, 60, (CURRENT_DATE + INTERVAL '905 days')::date), (16, 45, 55, (CURRENT_DATE + INTERVAL '905 days')::date),
-- Store 17: Phra Khanong (Residential staples)
(17, 21, 20, (CURRENT_DATE + INTERVAL '4 days')::date), (17, 28, 45, (CURRENT_DATE + INTERVAL '21 days')::date), (17, 47, 60, (CURRENT_DATE + INTERVAL '874 days')::date),
-- Store 18: Bang Na Inter (Large format store: Bulk buys)
(18, 3, 100, (CURRENT_DATE + INTERVAL '0 days')::date), (18, 31, 80, (CURRENT_DATE + INTERVAL '143 days')::date), (18, 40, 200, (CURRENT_DATE + INTERVAL '294 days')::date),
-- Store 19: Ramkhamhaeng (University area)
(19, 29, 70, (CURRENT_DATE + INTERVAL '303 days')::date), (19, 38, 55, (CURRENT_DATE + INTERVAL '14 days')::date), (19, 49, 65, (CURRENT_DATE + INTERVAL '822 days')::date),
-- Store 20: Bang Kapi Mall (High foot traffic mix)
(20, 22, 15, (CURRENT_DATE + INTERVAL '3 days')::date), (20, 33, 110, (CURRENT_DATE + INTERVAL '283 days')::date), (20, 54, 90, (CURRENT_DATE + INTERVAL '644 days')::date);
...
(1, 1, 100, (CURRENT_DATE + INTERVAL '1 days')::date), (2, 2, 100, (CURRENT_DATE + INTERVAL '173 days')::date), (3, 3, 150, (CURRENT_DATE + INTERVAL '1 days')::date), (4, 4, 100, (CURRENT_DATE + INTERVAL '4 days')::date), (5, 5, 100, (CURRENT_DATE + INTERVAL '14 days')::date),
(6, 6, 200, (CURRENT_DATE + INTERVAL '35 days')::date), (7, 7, 100, (CURRENT_DATE + INTERVAL '69 days')::date), (8, 8, 300, (CURRENT_DATE + INTERVAL '82 days')::date), (9, 9, 100, (CURRENT_DATE + INTERVAL '124 days')::date), (10, 10, 100, (CURRENT_DATE + INTERVAL '9 days')::date),
(11, 11, 150, (CURRENT_DATE + INTERVAL '11 days')::date), (12, 12, 50, (CURRENT_DATE + INTERVAL '174 days')::date),  (13, 13, 50, (CURRENT_DATE + INTERVAL '174 days')::date),  (14, 14, 10, (CURRENT_DATE + INTERVAL '325 days')::date),  (15, 15, 20, (CURRENT_DATE + INTERVAL '325 days')::date),
(16, 16, 100, (CURRENT_DATE + INTERVAL '247 days')::date), (17, 17, 100, (CURRENT_DATE + INTERVAL '285 days')::date), (18, 18, 100, (CURRENT_DATE + INTERVAL '30 days')::date), (19, 19, 50, (CURRENT_DATE + INTERVAL '56 days')::date),  (20, 20, 100, (CURRENT_DATE + INTERVAL '71 days')::date),

(21, 21, 100, (CURRENT_DATE + INTERVAL '4 days')::date),  -- Basil Minced Pork 
(22, 22, 150, (CURRENT_DATE + INTERVAL '3 days')::date),  -- Wonton Soup
(23, 23, 300, (CURRENT_DATE + INTERVAL '205 days')::date),  -- Mama Noodles
(24, 24, 200, (CURRENT_DATE + INTERVAL '205 days')::date),  -- Cup Noodles
(25, 25, 100, (CURRENT_DATE + INTERVAL '7 days')::date),  -- Banana Cake
(26, 26, 100, (CURRENT_DATE + INTERVAL '3 days')::date),  -- Pork Bun
(27, 27, 150, (CURRENT_DATE + INTERVAL '21 days')::date),  -- Bologna
(28, 28, 100, (CURRENT_DATE + INTERVAL '21 days')::date),  -- Frankfurter
(29, 31, 200, (CURRENT_DATE + INTERVAL '143 days')::date),  -- Magnum Ice Cream
(30, 35, 500, (CURRENT_DATE + INTERVAL '478 days')::date),  -- Crystal Water
(31, 36, 300, (CURRENT_DATE + INTERVAL '400 days')::date),  -- Sprite
(32, 42, 200, (CURRENT_DATE + INTERVAL '264 days')::date),  -- Leo Beer
(33, 44, 50,  (CURRENT_DATE + INTERVAL '691 days')::date),  -- Garnier Face Wash
(34, 50, 100, (CURRENT_DATE + INTERVAL '660 days')::date),  -- Gofen
(35, 52, 200, (CURRENT_DATE + INTERVAL '721 days')::date),  -- Poy-Sian Inhaler
(36, 56, 50,  (CURRENT_DATE + INTERVAL '905 days')::date),  -- Detergent
(37, 58, 100, (CURRENT_DATE + INTERVAL '1270 days')::date),  -- Toilet Tissue
(38, 59, 150, (CURRENT_DATE + INTERVAL '1270 days')::date),  -- Pens
(39, 60, 50,  (CURRENT_DATE + INTERVAL '1270 days')::date),  -- Umbrellas
(40, 38, 100, (CURRENT_DATE + INTERVAL '14 days')::date);  -- Dutch Mill Yoghurt
